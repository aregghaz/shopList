...
<div class="mj-container body-wrapper">
    ...
    <![endif]-->
    <div style="margin:0 auto;max-width:600px;background:#fff;" class="content-wrapper"
         data-class="content-wrapper">
        <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0;width:100%;background:#fff;"
            ...
            <tr>
                <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0;padding:0;">
                    ...
                    <div style="margin:0 auto;max-width:600px;">
                        <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0;width:100%;"
                               align="center" border="0">
                            <tbody>
                            <tr>
                                <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0;padding:0;">
                                    ...
                                    <div class="mj-column-per-100 outlook-group-fix"
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                            <tr>
                                                <td style="word-wrap:break-word;font-size:0;padding:0;"
                                                    align="center">
                                                    <table role="presentation" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td style="width:150px;">
                                                                <img alt="Logo" title="" height="auto"
                                                                     src="http://shoplist.am/img/logo.png"
                                                                     style="border:none;border-radius:0;display:block;font-size:13px;outline:none;text-decoration:none;width:100%;height:auto;"
                                                                     width="150">
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                            ...
                                            <tr>
                                                <td style="word-wrap:break-word;font-size:0px;padding:0px;"
                                                    ...
                                                    <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;">
                                                        <p>@lang('email.hello'), {{ $data['name'] }}</p>
                                                        <p class="hero">@lang('email.toRecoverPress')</p>
                                                        <p>@lang('email.pelaseConfirm')</p>
                                                        <p>
                                                            <a href="http://shoplist.am/restore-password?id={{ $data['id'] }}&token={{ $data['token'] }}" class="btn" mc:disable-tracking="">@lang('email.resetPass')</a>
                                                        </p>
                                                        <p>@lang('email.ifDontKnow')</p>
                                                        <hr style="margin-top: 56px">
                                                        <p class="mb-0">@lang('email.thanks'),</p>
                                                        <p class="mb-0">@lang('email.shoplistTeam')</p>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
